...
RUN pacman -S --noconfirm --needed --nodeps --overwrite="*" $( curl https://raw.githubusercontent.com/CachyOS/CachyOS-Live-ISO/refs/heads/master/archiso/packages_desktop.x86_64 | grep -v firefox  | grep -v linux-cachyos-lts  ) --ask=4

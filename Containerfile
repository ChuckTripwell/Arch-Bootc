...
# ---------------------------
# System essentials
ARG SYSTEM_PACKAGES="dracut linux linux-firmware ostree composefs systemd \
      btrfs-progs e2fsprogs xfsprogs udev cpio zstd binutils dosfstools \
      conmon crun netavark skopeo dbus dbus-glib glib2 shadow nix sddm"
...
# Multimedia
ARG MULTIMEDIA_PACKAGES="qt6-multimedia-ffmpeg plymouth flatpak acpid aha \
      clinfo ddcutil dmidecode mesa-utils ntfs-3g nvme-cli vulkan-tools \
...
ARG FIRMWARE_PACKAGES="amd-ucode intel-ucode edk2-shell efibootmgr shim mesa \
      libva-intel-driver libva-mesa-driver libva-nvidia-driver libva nvidia-open \
      vpl-gpu-rt vulkan-icd-loader vulkan-intel vulkan-radeon apparmor"

# Network / VPN / SMB
ARG NETWORK_PACKAGES="dnsmasq freerdp2 iproute2 iwd libmtp networkmanager-l2tp \
...
# Pipewire / audio
ARG PIPEWIRE_PACKAGES="pipewire pipewire-pulse pipewire-zeroconf \
      pipewire-ffado pipewire-libcamera sof-firmware wireplumber"
...
ARG USER_PACKAGES="accountsservice aspell cryfs editorconfig-core-c encfs ffmpeg \
      fwupd geoclue gocryptfs hspell icoutils jxrlib libappimage libavif libheif \
      libjxl libraw opencv openexr switcheroo-control"

# Hardware / Xorg / Wayland
ARG HARDWARE_PACKAGES="xorg-xwayland acsccid bmusb ccid dosfstools fprintd \
iio-sensor-proxy steam-devices-git thermald tpm2-tss tuned-ppd"
